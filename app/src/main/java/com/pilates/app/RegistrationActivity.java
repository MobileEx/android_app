...
public class RegistrationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    public void onClick(View v) {
        ...
        final HttpRequest httpRequest = new HttpRequest(Request.Method.POST,
                    "http://52.212.246.239:8082/user-management/api/v1/user/register",
//                "http://192.168.100.5:8082/user-management/api/v1/user/register",
                this, this, dto);
    ...
    @Override
    public void onResponse(final String userId) {
        final UserDto dto = registry.getDto();
        final UserSession userSession = new UserSession(Long.parseLong(userId), dto.getEmail(), dto.getRole());
