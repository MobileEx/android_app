...
public class UserRegistry {
    ...
    private final Map<Long, String> trainersById = new HashMap<>();
    private final Map<Long, String> traineesById = new HashMap<>();
    ...
    public void putAllTrainers(final Map<Long, String> trainees) {
    ...
    public void putTrainer(final Long id, final String username) {
    ...
    public void addTrainee(final Long id, final String username) {
        traineesById.put(id, username);
    }

    public void removeTrainee(final Long id) {
